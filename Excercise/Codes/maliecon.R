...
names(df1)[6]<-"Education mère"
names(df1)[7]<-"Education chef du ménage"
names(df1)[8]<-"Taille ménage"
names(df1)[9]<-"Garçon  école"
names(df1)[10]<-"Fille à l'école"
names(df1)[11]<-"Garçon jamais à l'école"
names(df1)[12]<-"Raison garçon jamais à l'école"
names(df1)[13]<-"Fille jamais à l'école"
names(df1)[14]<-"Raison fille jamais à l'école"
names(df1)[15]<-"Garçon arrête l'école"
names(df1)[16]<-"Raison garçon arrête l'école"
names(df1)[17]<-"Fille arrête l'école"
names(df1)[18]<-"Raison fille arrête l'école"
names(df1)[19]<-"Migrant est chef du ménage"
names(df1)[20]<-"Transferts de migrant 12 derniers mois"
names(df1)[21]<-"Trasnferts de migrant par téte"
...
names(df1)[28]<-"Nombre total de téte en bétail"
names(df1)[29]<-"Nombre source de revenu"
names(df1)[30]<-"Dépense mensuelle pour santé"
names(df1)[31]<-"Dépense mensuelle pour l'éducation"
names(df1)[32]<-"Dépense total"
names(df1)[33]<-"Dépense total par téte"
names(df1)[34]<-"Part de dépense total pour l'éducation"
...
names(df1)[42]<-"Ecole primaire dans village"
...
#renommé les variable de donnée 2
names(df2)[1] <-"Code région"
names(df2)[2]<-"Cercle"
names(df2)[3]<-"Code commune"
names(df2)[4]<-"Code village"
names(df2)[5]<-"Nombre enfants"
names(df2)[6]<-"Education mère"
names(df2)[7]<-"Education chef du ménage"
names(df2)[8]<-"Taille ménage"
names(df2)[9]<-"Garçon  école"
names(df2)[10]<-"Fille à l'école"
names(df2)[11]<-"Garçon jamais à l'école"
names(df2)[12]<-"Raison garçon jamais à l'école"
names(df2)[13]<-"Fille jamais à l'école"
names(df2)[14]<-"Raison fille jamais à l'école"
names(df2)[15]<-"Garçon arrête l'école"
names(df2)[16]<-"Raison garçon arrête l'école"
names(df2)[17]<-"Fille arrête l'école"
names(df2)[18]<-"Raison fille arrête l'école"
names(df2)[19]<-"Migrant est chef du ménage"
names(df2)[20]<-"Transferts de migrant 12 derniers mois"
names(df2)[21]<-"Trasnferts de migrant par téte"
...
names(df2)[28]<-"Nombre total de téte en bétail"
names(df2)[29]<-"Nombre source de revenu"
names(df2)[30]<-"Dépense mensuelle pour santé"
names(df2)[31]<-"Dépense mensuelle pour l'éducation"
names(df2)[32]<-"Dépense total"
names(df2)[33]<-"Dépense total par téte"
names(df2)[34]<-"Part de dépense total pour l'éducation"
...
names(df2)[42]<-"Ecole primaire dans village"
...
#Transformé les caractére en valeur numériques (donnée 1)
df1$`Nombre enfants`<- as.numeric(sub(",",".",df1$`Nombre enfants`))
df1$`Taille ménage`<- as.numeric(sub(",",".",df1$`Taille ménage`))
df1$`Garçon à l'école`<- as.numeric(sub(",",".",df1$`Garçon à l'école`))
df1$`Fille à l'école`<-as.numeric(sub(",",".",df1$`Fille à l'école`))
df1$`Garçon jamais à l'école`<-as.numeric(sub(",",".",df1$`Garçon jamais à l'école`))
df1$`Fille jamais à l'école`<-as.numeric(sub(",",".",df1$`Fille jamais à l'école`))
df1$`Garçon arrête l'école`<-as.numeric(sub(",",".",df1$`Garçon arrête l'école`))
df1$`Fille arrête l'école`<- as.numeric(sub(",",".",df1$`Fille arrête l'école`))
df1$`Transferts de migrant 12 derniers mois`<-as.numeric(sub(",",".",df1$`Transferts de migrant 12 derniers mois`))
df1$`Trasnferts de migrant par téte`<-as.numeric(sub(",",".",df1$`Trasnferts de migrant par téte`))
...
df1$`Nombre total de téte en bétail`<-as.numeric(sub(",",".",df1$`Nombre total de téte en bétail`))
...
df1$`Dépense mensuelle pour l'éducation`<-as.numeric(sub(",",".",df1$`Dépense mensuelle pour l'éducation`))
df1$`Dépense total`<-as.numeric(sub(",",".",df1$`Dépense total`))
df1$`Dépense total par téte`<-as.numeric(sub(",",".",df1$`Dépense total par téte`))
df1$`Part de dépense total pour l'éducation`<-as.numeric(sub(",",".",df1$`Part de dépense total pour éducation`))
...
df1$`Education mère`<-as.numeric(sub(",",".",df1$`Education mère`))
df1$`Education chef du ménage`<-as.numeric(sub(",",".",df1$`Education chef du ménage`))
df1$`Raison fille arrête l'école`<-as.numeric(sub(",",".",df1$`Raison fille arrête l'école`))
df1$`Raison fille jamais à l'école`<-as.numeric(sub(",",".",df1$`Raison fille jamais à l'école`))
df1$`Raison garçon arrête l'école`<-as.numeric(sub(",",".",df1$`Raison garçon arrête l'école`))
df1$`Raison garçon jamais à l'école`<-as.numeric(sub(",",".",df1$`Raison garçon jamais à l'école`))
...
df1$`Ecole primaire dans village`<-as.numeric(sub(",",".",df1$`Ecole primaire dans village`))

#Transformé les caractére en valeurs numériques (donn?e 2)
df2$`Nombre enfants`<- as.numeric(sub(",",".",df2$`Nombre enfants`))
df2$`Taille ménage`<- as.numeric(sub(",",".",df2$`Taille ménage`))
df2$`Garçon à l'école`<- as.numeric(sub(",",".",df2$`Garçon à l'école`))
df2$`Fille à l'école`<-as.numeric(sub(",",".",df2$`Fille à l'école`))
df2$`Garçon jamais à l'école`<-as.numeric(sub(",",".",df2$`Garçon jamais à l'école`))
df2$`Fille jamais à l'école`<-as.numeric(sub(",",".",df2$`Fille jamais à l'école`))
df2$`Garçon arrête l'école`<-as.numeric(sub(",",".",df2$`Garçon arrête l'école`))
df2$`Fille arrête l'école`<- as.numeric(sub(",",".",df2$`Fille arrête l'école`))
df2$`Transferts de migrant 12 derniers mois`<-as.numeric(sub(",",".",df2$`Transferts de migrant 12 derniers mois`))
df2$`Trasnferts de migrant par téte`<-as.numeric(sub(",",".",df2$`Trasnferts de migrant par téte`))
...
df2$`Nombre total de téte en bétail`<-as.numeric(sub(",",".",df2$`Nombre total de téte en bétail`))
...
df2$`Dépense mensuelle pour l'éducation`<-as.numeric(sub(",",".",df2$`Dépense mensuelle pour l'éducation`))
df2$`Dépense total`<-as.numeric(sub(",",".",df2$`Dépense total`))
df2$`Dépense total par téte`<-as.numeric(sub(",",".",df2$`Dépense total par téte`))
df2$`Part de dépense total pour l'éducation`<-as.numeric(sub(",",".",df2$`Part de dépense total pour l'éducation`))
...
df1$`Trasnferts de migrant par téte`<- round(df1$`Trasnferts de migrant par téte`,digits = 2)
df1$`Nombre de personne par pièce`<-round(df1$`Nombre de personne par pièce`,digits = 2)
df1$`Nombre total de téte en bétail`<-round(df1$`Nombre total de téte en bétail`,digits = 2)
df1$`Dépense mensuelle pour santé`<-round(df1$`Dépense mensuelle pour santé`,digits = 2)
df1$`Dépense mensuelle pour l'éducation`<-round(df1$`Dépense mensuelle pour l'éducation`,digits = 2)
df1$`Dépense total`<-round(df1$`Dépense total`,digits = 2)
df1$`Dépense total par téte`<-round(df1$`Dépense total par téte`,digits = 2)
df1$`Part de dépense total pour l'éducation`<-round(df1$`Part de dépense total pour l'éducation`,digits = 2)
...
df2$`Trasnferts de migrant par téte`<- round(df2$`Trasnferts de migrant par téte`,digits = 2)
df2$`Nombre de personne par pièce`<-round(df2$`Nombre de personne par pièce`,digits = 2)
df2$`Nombre total de téte en bétail`<-round(df2$`Nombre total de téte en bétail`,digits = 2)
df2$`Dépense mensuelle pour santé`<-round(df2$`Dépense mensuelle pour santé`,digits = 2)
df2$`Dépense mensuelle pour l'éducation`<-round(df2$`Dépense mensuelle pour l'éducation`,digits = 2)
df2$`Dépense total`<-round(df2$`Dépense total`,digits = 2)
df2$`Dépense total par téte`<-round(df2$`Dépense total par téte`,digits = 2)
df2$`Part de dépense total pour l'éducation`<-round(df2$`Part de dépense total pour l'éducation`,digits = 2)
...
summary(df2$`Garçon à l'école`)
summary(df2$`Fille à l'école`)
summary(df2$`Garçon jamais à l'école`)
summary(df2$`Fille jamais à l'école`)
summary(df2$`Garçon arrête l'école`)
summary(df2$`Fille arrête l'école`)
summary(df2$`Transferts de migrant 12 derniers mois`)
summary(df2$`Trasnferts de migrant par téte`)
...
summary(df2$`Nombre total de téte en bétail`)
summary(df2$`Nombre source de revenu`)
summary(df2$`Dépense mensuelle pour santé`)
summary(df2$`Dépense mensuelle pour l'éducation`)
summary(df2$`Dépense total`)
summary(df2$`Dépense total par téte`)
summary(df2$`Part de dépense total pour l'éducation`)
...
quantile(df2$`Dépense mensuelle pour l'éducation`)
...
barplot3<-ggplot(data = df2,mapping=aes(x=df2$`Code région`,y=df2$`Dépense mensuelle pour l'éducation`))+
  geom_bar(stat = "identity",aes(fill=df2$`Code région`),position = "dodge",col="transparent")+
  labs(subtitle = "Dépense mensuelle pour l'éducation par région",x="Région",y="Dépense mensuelle pour l'éducation")+
  guides(fill=guide_legend(title="Code de région"))+
  theme_bw()+
  theme(
    panel.grid.major = element_blank(),
...
sf3<-ggplot(map_and_data)+
  geom_sf(aes(fill=map_and_data$`Dépense mensuelle pour l'éducation`))+
  scale_fill_gradient(low = "#56B1F7",high = "#132B43")
sf3

map3<-tm_shape(map_and_data)+
  tm_polygons("Dépense mensuelle pour l'éducation",id="Code région",palette="Blues")
map3
...
sf5<-ggplot(map_and_data)+
  geom_sf(aes(fill=map_and_data$`Part de dépense total pour l'éducation`))+
  scale_fill_gradient(low = "#56B1F7",high = "#132B43")
sf5

map5<-tm_shape(map_and_data)+
  tm_polygons("Part de dépense total pour l'éducation",id="Code région",palette="Oranges")
map5
...
sf6<-ggplot(map_and_data)+
  geom_sf(aes(fill=map_and_data$`Garçon à l'école`))+
  scale_fill_gradient(low = "#56B1F7",high = "#132B43")
sf6

map6<-tm_shape(map_and_data)+
  tm_polygons("Gaçon à l'école",id="Code région",palette="Greens")
map6
...
sf7<-ggplot(map_and_data)+
  geom_sf(aes(fill=map_and_data$`Fille à l'école`))+
  scale_fill_gradient(low = "#56B1F7",high = "#132B43")
sf7

map7<-tm_shape(map_and_data)+
  tm_polygons("Fille à l'école",id="Code région",palette="Reds")
map7
